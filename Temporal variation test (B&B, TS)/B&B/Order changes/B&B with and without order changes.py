...
export_wmape_data_to_excel("B&B WMAPE (with and without order changes).xlsx", days, wmape_site_with_changes, wmape_site_without_changes, wmape_global_with_changes, wmape_global_without_changes)
