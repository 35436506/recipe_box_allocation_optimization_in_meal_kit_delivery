...
def plot_wmape_comparison(days, wmape_site_with_changes, wmape_site_without_changes, wmape_global_with_changes, wmape_global_without_changes):
    ...
    plt.ylabel('WMAPE')
    plt.title('WMAPE comparison: With vs Without order changes', pad=20, fontsize=14)
    plt.legend()
    plt.grid(True)
    plt.tight_layout()
    plt.show()
...
export_wmape_data_to_excel("WMAPE comparison.xlsx", days, wmape_site_with_changes, wmape_site_without_changes, wmape_global_with_changes, wmape_global_without_changes)
export_changed_deleted_orders_to_excel("Changed and deleted order quantity.xlsx", days, changed_orders_log, deleted_orders_log)