...
def run_allocation_process_over_time(start_day, end_day, total_orders):
    ...
    for day in range(start_day, end_day + 1):
        ...
        if day > start_day:
            ...
            allocation_ts, wmape_site_ts = tabu_search(allocations_ts[day-1]['allocation'], allocation_greedy, factory_capacities)
            ...
            allocation_ts = allocate_orders(orders, factory_capacities)
            allocation_greedy = allocation_ts
...
def export_to_excel(days, real_orders_proportions, wmape_site_values_ts, wmape_site_values_greedy, wmape_global_values, wmape_site_vs_final_ts, wmape_global_vs_final):
    ...
    wb.save("Temporal fixed test (TS).xlsx")
...
# Plot 3: WMAPE site and global comparison
